...
\resumeItem{Planing on pursuing a one-year Master's degree in Computer Science.}
\resumeItemListEnd
...
\resumeItem{Worked on a team-based business case study under the supervision of a dedicated mentor.}
\resumeItemListEnd
...
{\textbf{Bachelor thesis with NVIDIA} $|$ \emph{C++, CUDA, GPUDirect Storgage, CMake, Python}}{Oct. 2022 - Jun. 2023}
\resumeItemListStart
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
                ...
                \textbf{Languages}{: English (C2), Polish (Native), Spanish (B1) } \\
          }}
\end{itemize}
\vspace{-16pt}
