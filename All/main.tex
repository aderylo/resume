...
{Double degree: BSc in Computer Science \& BSc in Philosophy}{Warsaw, Poland}
\resumeItemListStart
...
\resumeItemListStart
\resumeItem{AAPD-01 team responsible for automation of fab processes.}
\resumeItem{Worked on improving the performance of deep learning models for photomask and die defect detection.}
\resumeItem{Collaborated on developing a custom BLIP2 based model for defect detection in photomasks.}
\resumeItem{Researched application of Stable Diffusion models for bootstrapping data for DL defect detection and classification models.}
\resumeItem{Collaborated on optimizing interference of LLM models inside rule based captioning pipelines.}
\resumeItem{Top-8 internship performance among cohort of 80+ interns.}
\resumeItemListEnd
