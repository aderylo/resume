...
\resumeItemListStart
\resumeItem{Best technical univeisty in Germany according to the QS rating.}
\resumeItemListEnd
...
{SWE Intern}{Madrid, Spain}
\resumeItemListStart
\resumeItem{NintAI applied science team responsible for ML models faciliating image search at Amazon.}
\resumeItem{Added several features to the ML inference platofrm as well as developed Web App for it.}
\resumeItem{Built and deployed the UI infrastructure from scratch using AWS CodePipeline and CodeBuild,
 ensuring seamless integration with SIGV4 authentication and resolving CORS issues.}
\resumeItem{Implemented end-to-end tests using NightwatchJS and Selenium Grid, 
and integrated them into the CI/CD pipeline, establishing cross-account VPC connectivity between test workers and build services.}
\resumeItem{Utilized AWS CDK for infrastructure as code, alongside AWS services such as 
API Gateway, CloudWatch, S3, DynamoDB, Lambda, and many more to deploy and monitor the platform.}
\resumeItemListEnd
...
{\textbf{Bachelor thesis at Nencki Institute} $|$ \emph{Python, Pytorch, Tianshou} }{Nov. 2023 - Oct. 2024}
\resumeItemListStart
...
\resumeItem{Such reconstruction allows for modifying parts of compiled code without hassels of full decompilation.}
\resumeItemListEnd
