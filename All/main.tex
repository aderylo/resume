...
\resumeItemListStart
\resumeItem{AAPD-01 team responsible for automation of fab processes on various established nodes.}
\resumeItem{Worked on improving the performance of deep learning models for photomask and die defect detection.}
\resumeItem{Researched custom multimodal generative AI models based on BLIP2 \& Stable Diffusion for bootstrapping 
data for DL defect detection and classification models.}
