...
\resumeItemListStart
\resumeItem{AI Application department resonsible for interanl tooling and automation of 200nm fab.}
...
\resumeItemListStart
\resumeItem{Developed various custom features for the Minix OS, including modifying kernel.}
\resumeItem{Implemented theoratially optimal scheduler, improving the performance of the system.}
