...
{Software Engineering Intern | AWS CDK, Typescript, React}{Madrid, Spain}
\resumeItemListStart
\resumeItem{Developed and deployed a web application for an ML inference platform, responsible for image search at Amazon.}
\resumeItem{Implemented UI infrastructure using AWS services (CodePipeline, CodeBuild, API Gateway, Lambda), ensuring seamless integration with authentication and resolving cross-origin issues.}
\resumeItem{Established end-to-end testing framework with NightwatchJS and Selenium Grid, integrating it into the CI/CD pipeline.}
\resumeItem{Utilized AWS CDK for infrastructure as code, improving deployment efficiency and monitoring capabilities.}
\resumeItemListEnd
