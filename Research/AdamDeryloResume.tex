...
{\textbf{Bachelor thesis for NVIDIA} $|$ \emph{C++, CUDA, Python}}{Oct. 2022 - Present}
\resumeItemListStart
...
\resumeItem{Gained hands-on experience with CUDA virtual memory management, under the guidance of NVIDIA employees.}
\resumeItemListEnd
\vspace{-13pt}
\resumeProjectHeading
