...
\resumeItemListStart
\resumeItem{AAPD team responsible for automation of fab processes.}
\resumeItem{Collaborated on developing a custom BLIP2 based model for photomask defect detection.}
\resumeItem{Researched application of Stable Diffusion models for bootstrapping data for DL defect classification models.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
                \textbf{2nd Place}{, BEST Hacking league} \\
