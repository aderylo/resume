...
\resumeItemListStart
\resumeItem{AI Application and Platfrom Development team responsible for automation of fab processes.}
\resumeItem{Developed custom BLIP2 based model for photomask defect classification and dataset bootstrapping.}
\resumeItem{Prototyped application of Stable Diffusion models for bootstrapping rare defect data quickly.}
\resumeItem{Ranked top 8 out of 80+ Interns in the final competion.}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{Worked with NVIDIA DALI team on accelerating image decompression in astronomy workflows.}
\resumeItem{Contributed module to the open-source DALI library, improving the performance of the FITS decoder.}
\resumeItem{Showcased the result by rewriting NASA Coronal Hole Semantic Segmenation piepline and achieving 70\% speedup.}
\resumeItemListEnd
\vspace{-13pt}
\resumeProjectHeading
